  ...
  private async seedHardware(): Promise<void> {
    ...
    const HARDWARE: HardwareSeed[] = [
      ...
      // ---------- 灯带恒压 DALI 电源 (12 台 HLG + 1 台 HLG-600 灯箱) ----------
      {
        ...
        addressing: JSON.stringify({ daliShort: 1, daliGroup: 1, output: 'DC 24V 320W' }),
        remark: '前厅灯带 30m / 300W, DALI 2.0',
      },
      {
      ...
      },
      {
        ...
        vendor: 'MEANWELL 明纬', model: 'HLG-120H-24DA', floor: '1F', location: '1F 公共电箱 F101',
        addressing: JSON.stringify({ daliShort: 3, daliGroup: 4, output: 'DC 24V 120W' }),
        remark: '园区展示灯带 12m / 120W',
      },
      {
      ...
      {
        code: 'DRV-HLG-13', name: '1F F101-R3 灯箱电源', category: 'dali-dimmer',
        vendor: 'MEANWELL 明纬', model: 'HLG-600H-24DA', floor: '1F', location: '1F 公共电箱 F101',
        addressing: JSON.stringify({ daliShort: 13, daliGroup: 4, output: 'DC 24V 600W' }),
        remark: '园区展示灯箱 12㎡ / 600W',
      },
      // ---------- DALI→0-10V 转换器 (3 台, 11 路 AC 220V 灯具调光) ----------
      {
        ...
        addressing: JSON.stringify({ daliStart: 14, daliCount: 4, mode: '4×0-10V' }),
        channels: JSON.stringify([
          { ch: 1, daliShort: 14, label: 'F101-R2 筒+射 (9+13)', powerW: 450, daliGroup: 4 },
          { ch: 2, daliShort: 15, label: 'F101-R3 筒灯 (14)', powerW: 880, daliGroup: 4 },
          { ch: 3, daliShort: 16, label: 'F101-R5 走廊筒+射 (29+10)', powerW: 800, daliGroup: 3 },
          { ch: 4, daliShort: 17, label: 'F101-R6 吸顶灯 (2)', powerW: 60, daliGroup: 3 },
        ]),
      ...
      },
      {
        ...
        addressing: JSON.stringify({ daliStart: 18, daliCount: 4, mode: '4×0-10V' }),
        channels: JSON.stringify([
          { ch: 1, daliShort: 18, label: 'F101-R7 格栅长条灯 35m', powerW: 700, daliGroup: 4 },
          { ch: 2, daliShort: 19, label: 'F103-R1 筒+射 (7+12)', powerW: 400, daliGroup: 6 },
          { ch: 3, daliShort: 20, label: 'F201-R1 筒灯 (30)', powerW: 600, daliGroup: 8 },
          { ch: 4, daliShort: 21, label: 'F201-R2 筒灯 (10)', powerW: 1200, daliGroup: 8 },
        ]),
        remark: '灯具需 0-10V 调光款',
      },
      {
        ...
        addressing: JSON.stringify({ daliStart: 22, daliCount: 4, mode: '4×0-10V' }),
        channels: JSON.stringify([
          { ch: 1, daliShort: 22, label: 'F201-R3 筒+射 (16+3)', powerW: 1000, daliGroup: 9 },
          { ch: 2, daliShort: 23, label: 'F202-R1 吸顶 (13)', powerW: 800, daliGroup: 10 },
          { ch: 3, daliShort: 24, label: 'F203-R1 吸顶 (16)', powerW: 1000, daliGroup: 11 },
          { ch: 4, daliShort: 25, label: 'F204-R1 吸顶 (15)', powerW: 900, daliGroup: 12 },
        ]),
        remark: '灯具需 0-10V 调光款',
      },
      // ---- LED 大屏 ----
