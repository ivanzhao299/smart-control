...
const DEVICES: DeviceSeed[] = [
  ...
  { name: 'hvac_1f_exhibit_1',     category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'enterprise_booth_1', address: '{"gwHost":"192.168.1.66","n":0,"model":"DLR-63F","kw":1.8}' },
  { name: 'hvac_1f_exhibit_2',     category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'enterprise_booth_2', address: '{"gwHost":"192.168.1.66","n":1,"model":"DLR-63F","kw":1.8}' },
  { name: 'hvac_1f_exhibit_3',     category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'enterprise_booth_3', address: '{"gwHost":"192.168.1.66","n":2,"model":"DLR-63F","kw":1.8}' },
  { name: 'hvac_1f_livestream',    category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'livestream',         address: '{"gwHost":"192.168.1.66","n":3,"model":"DLR-71F","kw":2.0}' },
  { name: 'hvac_1f_trade_1',       category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'foreign_trade_1',    address: '{"gwHost":"192.168.1.66","n":4,"model":"DLR-71F","kw":2.0}' },
  { name: 'hvac_1f_trade_2',       category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'foreign_trade_2',    address: '{"gwHost":"192.168.1.66","n":5,"model":"DLR-80F","kw":2.0}' },
  { name: 'hvac_1f_park_display',  category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'park_display',       address: '{"gwHost":"192.168.1.66","n":6,"model":"DLR-90F","kw":2.2}' },
  { name: 'hvac_1f_roadshow_1',    category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'roadshow_1',         address: '{"gwHost":"192.168.1.66","n":7,"model":"DLR-100F","kw":2.2}' },
  { name: 'hvac_1f_roadshow_2',    category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'roadshow_2',         address: '{"gwHost":"192.168.1.66","n":8,"model":"DLR-112F","kw":2.2}' },
  { name: 'hvac_1f_showcase',      category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '1F', zone: 'enterprise_showcase',address: '{"gwHost":"192.168.1.66","n":9,"model":"DLR-125F","kw":2.2}' },
  // 2F (网关 192.168.50.52, n=0..11)
  { name: 'hvac_2f_group_mgmt',    category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'group_mgmt',         address: '{"gwHost":"192.168.1.67","n":0,"model":"DLR-90F","kw":2.2}'  },
  { name: 'hvac_2f_decision',      category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'decision_center',    address: '{"gwHost":"192.168.1.67","n":1,"model":"DLR-90F","kw":2.2}'  },
  { name: 'hvac_2f_meeting',       category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'meeting_room',       address: '{"gwHost":"192.168.1.67","n":2,"model":"DLR-90F","kw":2.2}'  },
  { name: 'hvac_2f_shared_1',      category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'shared_office_1',    address: '{"gwHost":"192.168.1.67","n":3,"model":"DLR-90F","kw":2.2}'  },
  { name: 'hvac_2f_shared_2',      category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'shared_office_2',    address: '{"gwHost":"192.168.1.67","n":4,"model":"DLR-90F","kw":2.2}'  },
  { name: 'hvac_2f_service_1',     category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'service_center_1',   address: '{"gwHost":"192.168.1.67","n":5,"model":"DLR-90F","kw":2.2}'  },
  { name: 'hvac_2f_service_2',     category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'service_center_2',   address: '{"gwHost":"192.168.1.67","n":6,"model":"DLR-90F","kw":2.2}'  },
  { name: 'hvac_2f_command_1',     category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'command_center_1',   address: '{"gwHost":"192.168.1.67","n":7,"model":"DLR-90F","kw":2.2}'  },
  { name: 'hvac_2f_command_2',     category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'command_center_2',   address: '{"gwHost":"192.168.1.67","n":8,"model":"DLR-90F","kw":2.2}'  },
  { name: 'hvac_2f_lobby_1',       category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'lobby_1',            address: '{"gwHost":"192.168.1.67","n":9,"model":"DLR-100F","kw":2.2}' },
  { name: 'hvac_2f_lobby_2',       category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'lobby_2',            address: '{"gwHost":"192.168.1.67","n":10,"model":"DLR-100F","kw":2.2}' },
  { name: 'hvac_2f_research',      category: 'hvac', protocol: 'modbus-tcp', adapter: 'zhonghong-mbt', floor: '2F', zone: 'research_center',    address: '{"gwHost":"192.168.1.67","n":11,"model":"DLR-100F","kw":2.2}' },
];
