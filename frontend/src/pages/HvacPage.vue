...
.hv-cell.drag-over { border-color: var(--v2-primary, #4C9AFF); box-shadow: 0 0 0 2px var(--v2-primary, #4C9AFF) inset; }
/* 运行卡片: 有色底 + 左侧彩条, 关机卡片纯深灰 —— 开关机一眼可辨 */
.hv-cell.running {
  background: linear-gradient(160deg, #123049, #14161A);
  border-color: #2b4a63;
...
.hv-cell.unknown {
  border-style: dashed;
  border-color: #3c4a5e;
  background: repeating-linear-gradient(45deg, #14161A, #14161A 7px, #171f2c 7px, #171f2c 14px);
}
...
.cell-dot {
  ...
  background: #223044; color: #9BA1A9; flex: 0 0 auto;
}
